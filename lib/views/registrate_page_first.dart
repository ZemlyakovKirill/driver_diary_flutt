...
class RegistratePageFirst extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocConsumer<RegistrationValidationBloc, RegistrationValidationState>(
  listener: (context, state) {
    if(state is FirstStageErrorValidationState){
      ...
      BlocProvider.of<RedirectBloc>(context).add(RedirectToSecondRegistratePageEvent(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(15)),
                            child: TextButton(
                              onPressed: ()=>BlocProvider.of<RegistrationValidationBloc>(context)..add(FirstStageValidationEvent(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15)),
                      child: TextButton(
                        onPressed: () => BlocProvider.of<RedirectBloc>(context).add(RedirectToLoginPageEvent()),
